...
(cl:defmethod cl:initialize-instance :after ((m <Whls_vel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Whls_vel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hall_sensor-msg:<Whls_vel> is deprecated: use hall_sensor-msg:Whls_vel instead.")))
